...
/**
 * Scrubs user identity and conversation content from Sentry events and breadcrumbs
 ...
 * Conversation content and user identity must not appear in crash reports. Rather
 * than attempting to detect specific patterns — which is fragile — we take the
 ...
 *   from sensitive packages. Exception *type* and the full *stack trace* are
 ...
 *   can carry conversation content.
 *
